...
using WebAppIdenty.Models;
using WebAppIdenty.Models.AccountViewModels;
using WebAppIdenty.Services;
...
namespace WebAppIdenty.Controllers
{
    ...
    public class AccountController : Controller
    {
        ...
        public AccountController(
            ...
            ILoggerFactory loggerFactory, AppSettings appSettings)
        {
        ...
        public async Task<IActionResult> PolicyLogin(string returnUrl = null)
        {
            ...
            await HttpContext.Authentication.SignInAsync("Cookie", userPrincipal,
                ...
                {
                    ExpiresUtc = DateTime.UtcNow.AddMinutes(20000),
                    IsPersistent = false,
                    AllowRefresh = false
                }
                );
            return RedirectToLocalq(returnUrl);
        }

        private IActionResult RedirectToLocalq(string returnUrl)
        {
            if (Url.IsLocalUrl(returnUrl))
            {
                return Redirect(returnUrl);
